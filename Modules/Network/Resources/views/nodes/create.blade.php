...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-sitemap"></i> Crear Nuevo Nodo
        </h1>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('name') }}" 
                                   required
                                   placeholder="Ej: Nodo Central Cusco">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                Core: Núcleo | Distribution: Distribución | Access: Acceso | Backbone: Troncal
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('parent_node_id') is-invalid @enderror" 
                                ...
                                <option value="{{ $parentNode->id }}" {{ old('parent_node_id') == $parentNode->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @error('capacity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">Capacidad máxima de clientes</small>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" 
                                       ...
                                       name="is_operational" 
                                       value="1"
                                       {{ old('is_operational', true) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="5"
                                      placeholder="Descripción adicional del nodo...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
